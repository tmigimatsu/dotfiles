...
syntax match   javaScriptSymbolOp       "[\-\+\*\/\=\<\>\!\|\&\$]"
...
syntax match   javaScriptNumber         /\<-\=\d\+L\=\>\|\<0[xX]\x\+\>/ contains=javaScriptSymbolOp
...
"" Code blocks
syntax cluster javaScriptAll       contains=javaScriptComment,javaScriptLineComment,javaScriptDocComment,javaScriptStringD,javaScriptStringS,javaScriptRegexpString,javaScriptNumber,javaScriptFloat,javaScriptLabel,javaScriptSource,javaScriptType,javaScriptOperator,javaScriptBoolean,javaScriptNull,javaScriptFunction,javaScriptConditional,javaScriptRepeat,javaScriptBranch,javaScriptStatement,javaScriptGlobalObjects,javaScriptExceptions,javaScriptFutureKeys,javaScriptDomErrNo,javaScriptDomNodeConsts,javaScriptHtmlEvents,javaScriptDotNotation,javaScriptFuncAnon,javaScriptSymbolOp,javaScriptFuncVar
...
if exists("b:javascript_fold")
	" syntax match   javaScriptVar            "var\sfun"
	" syntax match   javaScriptFuncVar        /[a-zA-Z0-9]\s\=\sf/ contains=javaScriptType,javaScriptFuncAnon
	syntax match   javaScriptFuncAnon       /\<function\>/ nextgroup=javaScriptParameter contained
	syntax match   javaScriptFunction       /\<function[^(]/ nextgroup=javaScriptFuncName skipwhite
    " syntax match   javaScriptOpAssign       /=\@<!=/ nextgroup=javaScriptFuncBlock skipwhite skipempty
    syntax region  javaScriptFuncName       contained start=/\%(\$\|\w\)/ end="[^(]*" contains=javaScriptComment nextgroup=javaScriptParameter skipwhite skipempty keepend
	syntax match   javaScriptParameter      "([^)]*)" contains=javaScriptParens,javaScriptComma nextgroup=javaScriptFuncBlock skipwhite skipempty contained
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  HiLink javaScriptFuncAnon             Identifier
  ...
  HiLink javaScriptSymbolOp             Operator
