...
" if !exists('g:cpp_no_function_highlight')
    ...
    " syn match    cCustomFunc     "\I\i*\s\+\(\w\+::\)\?\w\+\s*(\@=" contains=cCustomParen,cType,cppType
...
syn match cOperator	"<<\|>>\|&&\|||\|++\|--\|->"
syn match cOperator	"[.!~*&%<>^|=+-]"
syn match cTernary "[[:space:][:alnum:])_][?:][[:space:][:alnum:](_]" contains=cTernaryOperator
syn match cTernaryOperator "[?:]" contained
...
hi def link cTernaryOperator		Operator
